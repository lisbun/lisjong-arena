...
- RiichiEnv Adapterはcanonical physical implementation・lisjong legacy cleanup・Arena exact pin syncのすべてが完了し(上記)、pillarとしてCOMPLETEである。`GameTrace`はまだ`lisjong`に存在する
