...
- `lisjong` dependencyは再現可能性のためrelease tagが出るまでfull commit SHAへpinする。現在のpinは`376f69088a134b5a9bcc33a69b95e3f779eb2b0e`である(Issue #45でGameTrace cleanup後revisionへ同期)
