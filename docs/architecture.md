...
このexact pin syncにより、LocalGameRunner / LocalGameResult pillarのphysical duplicateは完全解消した。RiichiEnv Adapter / GameTraceのphysical migrationは引き続きfuture workである。
